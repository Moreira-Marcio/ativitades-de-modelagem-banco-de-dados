...
(1, 'ultrabook', 'equipamento de ultima geração cheio de recursos, e etc e tal...', 3999.45, 7, 2),
(2, 'tablet androide', 'tablet versão 16 do sistema operacional androide, possui tela de 10 polegadas e armazenamento de 128 gb ', 900.00, 12, 5),
(3, 'geladeira', 'Refrigeradpr frost-free com acesso a internet', 5000.00, 12, 6),
(4, 'iphone 18 pro max ferradão', 'Smartphone apple cheio das frescuras e caro pra caramba', 9666.66, 3, 3),
(5, 'ipad mini', 'tablet apple com tela retina display e bla bla bla', 4999.99, 5, 3),
(6, 'Xbox Series S', 'Velocidade e desempenho de última geração', 1997.00, 5, 7),
